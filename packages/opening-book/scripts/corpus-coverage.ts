...
const UNWRITABLE = new Map<string, string>([
  ...
  [
    ...
    'Yugoslav Attack with 7...Nc6: what the node itself attracts is transposition bookkeeping — that 7...O-O 8.Qd2 Nc6 is the same position, that 7...h5 8.Qd2 Nbd7 9.h3 a6 becomes a Dragadorf. The plans sit two plies below at the ninth-move crossroads, which is written. The only independent content is the schemes where Black delays castling, 8...Bd7 and 8...h5, and at depth 3 with a 110-character floor each of those rests on a single course.',
  ],
  [
